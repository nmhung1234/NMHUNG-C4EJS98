...
console.log('-------------15.4------------------------------');
console.log('The benefits of the first job hit:')
console.log(data.hits[0].benefits);

// 15.5 Log out first job hit benefit values
console.log('-------------15.5------------------------------');
console.log('First job hit benefit:')
for(let ben of data.hits[0].benefits)
console.log('- ' + ben.benefitValue);

//15.6 Log out jobTitle and benefitValue of all job 
console.log('-------------15.6------------------------------');
for (let i = 0; i < data.hits.length; i++) {
    console.log(data.hits[i].jobTitle);
    console.log('Benefit:')
    for(let ben of data.hits[i].benefits)
    console.log('- ' + ben.benefitValue);
    console.log('---------------');
}
...
console.log('-------------15.7------------------------------');
for (let i = 0; i < data.hits.length; i++) {
    console.log('Title:',data.hits[i].jobTitle);
    console.log(`Location: ${data.hits[i].locations}`);
    console.log('Skills:');
    for(let j= 0; j< data.hits[i].skills.length; j++)
    {
        console.log(`- ${data.hits[i].skills[j]}`)
    }
    console.log(`JobSalary: ${data.hits[i].jobSalary}$`);
    console.log('---------------');
}