...
let quotesNumber = qoutes.length;
let quoteContent = document.getElementById("quote-content");
let quoteAuthorr = document.getElementById("quote-author");

let randquoteNumber = Math.floor(Math.random()*quotesNumber);
console.log(quoteContent)
quoteContent.innerText = qoutes[randquoteNumber].quoteText;
quoteAuthorr.innerText = qoutes[randquoteNumber].quoteAuthor;
